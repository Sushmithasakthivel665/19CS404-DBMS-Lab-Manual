...
```
## output:
<img width="853" height="397" alt="image" src="https://github.com/user-attachments/assets/ccd81d67-20a4-4969-8bad-c9ce2c363133" />
...
```
## output:
<img width="836" height="332" alt="image" src="https://github.com/user-attachments/assets/051740f9-7955-4de8-9110-73cdb5ab1d80" />
...
COMMIT;
SELECT * FROM products;CREATE TABLE products (
    product_id NUMBER PRIMARY KEY,
    product_name VARCHAR2(50),
    price NUMBER
);
...
```
## output:
<img width="817" height="280" alt="image" src="https://github.com/user-attachments/assets/73e741f2-0717-48cd-9b31-593d97089a02" />
...
```
## output:
<img width="657" height="252" alt="image" src="https://github.com/user-attachments/assets/72aebd5b-eb4b-4d86-a61e-14bb9e59ad64" />
...
```
## output:
<img width="777" height="320" alt="image" src="https://github.com/user-attachments/assets/f221811c-1523-4383-8592-aad1d42d229a" />
